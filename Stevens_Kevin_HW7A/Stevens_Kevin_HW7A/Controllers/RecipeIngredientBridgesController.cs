...
namespace Stevens_Kevin_HW7A.Controllers
{
    public class RecipeIngredientBridgesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RecipeID,IngredientID,MeasurementType,MeasurementQuantity")] RecipeIngredientBridge recipeIngredientBridge)
        {
            ...
            ViewBag.RecipeID = new SelectList(db.Recipes, "RecipeID", "Name", recipeIngredientBridge.RecipeID);
            return View(recipeIngredientBridge);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecipeID,IngredientID,MeasurementType,MeasurementQuantity")] RecipeIngredientBridge recipeIngredientBridge)
        {
            if (ModelState.IsValid)
            {
